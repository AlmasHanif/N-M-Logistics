...
const ReviewCard = () => {
    return (
        <>
            <div className="container flex flex-col items-center justify-start mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10 w-full h-full reviewCard">
                <div className="flex flex-col max-w-sm shadow-lg">
                    <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-gray-900 reviewPara">
